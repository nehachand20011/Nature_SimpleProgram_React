    ...
    <footer className="py-5">
      ...
      <div className="d-flex flex-column flex-sm-row justify-content-between py-4 my-4 border-top">
        ...
        <ul className="list-unstyled d-flex">
          <li className="ms-3">
            <Link className="link-body-emphasis" to="#"><i class="fa-brands fa-x-twitter fa-beat fs-3" ></i></Link></li>
          <li className="ms-3">
            <Link className="link-body-emphasis" to="#"><i class="fa-brands fa-instagram fa-beat fs-3"></i></Link></li>
          <li className="ms-3">
            <Link className="link-body-emphasis" to="#"><i class="fa-brands fa-linkedin fa-beat fs-3"></i></Link></li>
        </ul>
      </div>
    </footer>
  </div>
